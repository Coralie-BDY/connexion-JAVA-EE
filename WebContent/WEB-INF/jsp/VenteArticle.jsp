    	...
    	<div class="row mt-5">
     		 <div class="col-sm-10 col-md-10 col-lg-10 mx-auto">
  				...
  				<div class="row no-gutters">
    				...
    				<div class="col-md-8">
      					<div class="card-body">
        					<h5 class="card-title text-center"> NOUVELLE VENTE</h5>
   							<form  class="form-register needs-validation" action="${pageContext.request.contextPath}/Vente" method="POST" enctype="multipart/form-data">
								...
								<legend>Article</legend>  
	              				...
	              				<div class="row">
	                  				<div class="col-md-6 mb-3">
	                      				...
	                      				<input type="text" class="form-control" id="nom_article" name="nom_article" placeholder="Nom de votre article" maxlength="30" required value="">
	                  				</div>
	              				</div>
	              				...
	              				<div class="row">
	                  				<div class="col-md-12 mb-3">
	                     				...
	                     				<textarea class="form-control" id="description" name="description" placeholder="Quelques mots pour décrire votre produit (500 caractères maximum)." value="" rows="4" cols="" maxlength="500" required></textarea>
	                  				</div>
	              				</div>
	              				...
	              				<div class="row">
	                  				...
	                  				<div class="col-md-6 mb-3">
	                      				<label for="prix_initial">Prix initial</label>
	                       				<input type="number" class="form-control" id="prix_initial" name="prix_initial" placeholder="" value="0" maxlength="20" required>
	                   				</div>
	                   				...
	                   				<div class="row col-md-6 ml-1 mb-3">
	                   					...
	                   					<div class="input-group ">
 											<div class="input-group-prepend">
    											<span class="input-group-text" name="image" id="inputGroupFileAddon01">Uploader</span>
  											</div>
	                		...
	                		<div class="row">  
	                  			<div class="col-md-6 mb-3">
	                      			<label for="dateDebut">Date d'ouverture de l'enchère</label>
	                      			<input type="date" class="form-control" id="dateDebut" name="dateDebut" placeholder="" value="${date}" required>                       
					      			<p id="test"></p> 
					  			</div>
	 
								<div class="col-md-6 mb-3">
	      							<label for="dateheuredebut">Heure d'ouverture de l'enchère</label>
	     							<input type="time" class="form-control" id="heureDebut" name="heureDebut" placeholder="" value="${time}" required>
	                			</div>
